...
---'Ch No.' || CAST((CASE WHEN T2."TransType" = 46 THEN T8."CheckNum" WHEN T2."TransType" = 24 THEN T9."CheckNum" END) AS char) 
 CAST((CASE WHEN T2."TransType" = 46 THEN t8."CheckNum" 
 WHEN T2."TransType" = 24 THEN t9."CheckNum" end) as varchar)
"Description 2", 
...
LEFT OUTER JOIN (SELECT top 1 "CheckNum" , "DocNum" FROM VPM1) AS T8 ON T8."DocNum" = T4."DocEntry"
